...
public class VehicleTableArrangements_StepDefinitions {
    ...
    @Then("user sees the value of View Per Page as {int}")
    public void user_sees_the_value_of_view_per_page_as(Integer int1) {
    ...
    @Then("user should see {double}{double} and {int}")
    public void userShouldSeeAnd(int arg0, int arg1, int arg2, int arg3) {
